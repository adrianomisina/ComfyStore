...
const ProductsContainer = () => {
  ...
  const setActivesStyles = (pattern) => {
    ...
    <>
      ...
      <div className='flex justify-between items-center mt-8 border-b border-base-300 pb-5'>
        ...
        <div className='flex gap-x-2'>
          <button type='button' onClick={() => setLayout('grid')} className={setActivesStyles('grid')}>
            <BsFillGridFill />
          </button>

          <button type='button' onClick={() => setLayout('list')} className={setActivesStyles('list')}>
            <BsList />
          </button>
        </div>
